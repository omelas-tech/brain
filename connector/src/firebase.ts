...
export function loginPageHtml(opts: {
  ...
  // The "Neon glow" brand mark (palette multi, style glow) in 256-space — the
  // same icon as the website/app favicon (website/scripts/gen-icon.mjs). Defs and
  // body are split so the page can reuse them in both the favicon and the inline
  // "your brain" node glyph. Ids are prefixed "bm" (favicon is a separate doc).
  const NET_DEFS =
    `<filter id="bm-lg" x="-20%" y="-20%" width="140%" height="140%"><feGaussianBlur stdDeviation="1.6"/></filter>` +
    `<radialGradient id="bm-g0"><stop offset="0%" stop-color="#adb5c2" stop-opacity="1.00"/><stop offset="100%" stop-color="#5A6B84" stop-opacity="0"/></radialGradient>` +
    `<radialGradient id="bm-g1"><stop offset="0%" stop-color="#b7d4eb" stop-opacity="0.66"/><stop offset="100%" stop-color="#6FA8D6" stop-opacity="0"/></radialGradient>` +
    `<radialGradient id="bm-g2"><stop offset="0%" stop-color="#f8d09f" stop-opacity="0.67"/><stop offset="100%" stop-color="#F0A03E" stop-opacity="0"/></radialGradient>` +
    `<radialGradient id="bm-g3"><stop offset="0%" stop-color="#9fc7c7" stop-opacity="0.80"/><stop offset="100%" stop-color="#3F8E8E" stop-opacity="0"/></radialGradient>` +
    `<radialGradient id="bm-g4"><stop offset="0%" stop-color="#fae1a5" stop-opacity="0.70"/><stop offset="100%" stop-color="#F5C24B" stop-opacity="0"/></radialGradient>`;
  const NET_BODY =
    `<g filter="url(#bm-lg)" opacity="0.9">` +
    `<line x1="128" y1="128" x2="138.9" y2="230.8" stroke="#658aad" stroke-width="3.71" stroke-opacity="0.40" stroke-linecap="round"/>` +
    `<line x1="128" y1="128" x2="231.4" y2="127.5" stroke="#a89768" stroke-width="3.84" stroke-opacity="0.42" stroke-linecap="round"/>` +
    `<line x1="128" y1="128" x2="24.8" y2="134.6" stroke="#a58661" stroke-width="3.73" stroke-opacity="0.41" stroke-linecap="round"/>` +
    `<line x1="138.9" y1="230.8" x2="231.4" y2="127.5" stroke="#b2b591" stroke-width="2.75" stroke-opacity="0.30" stroke-linecap="round"/>` +
    `<line x1="138.9" y1="230.8" x2="24.8" y2="134.6" stroke="#b0a48a" stroke-width="2.64" stroke-opacity="0.29" stroke-linecap="round"/>` +
    `<line x1="24.8" y1="134.6" x2="122.7" y2="24.7" stroke="#989766" stroke-width="3.10" stroke-opacity="0.34" stroke-linecap="round"/>` +
    `<line x1="128" y1="128" x2="122.7" y2="24.7" stroke="#4d7d89" stroke-width="4.18" stroke-opacity="0.45" stroke-linecap="round"/>` +
    `<line x1="122.7" y1="24.7" x2="231.4" y2="127.5" stroke="#9aa86d" stroke-width="3.22" stroke-opacity="0.35" stroke-linecap="round"/></g>` +
    `<circle cx="128" cy="128" r="62.40" fill="url(#bm-g0)"/><circle cx="128" cy="128" r="18.72" fill="#dbdee4" fill-opacity="1.00"/>` +
    `<circle cx="138.9" cy="230.8" r="34.66" fill="url(#bm-g1)"/><circle cx="138.9" cy="230.8" r="10.40" fill="#dfecf6" fill-opacity="0.80"/>` +
    `<circle cx="24.8" cy="134.6" r="35.06" fill="url(#bm-g2)"/><circle cx="24.8" cy="134.6" r="10.52" fill="#fcead5" fill-opacity="0.80"/>` +
    `<circle cx="122.7" cy="24.7" r="46.49" fill="url(#bm-g3)"/><circle cx="122.7" cy="24.7" r="13.95" fill="#d5e6e6" fill-opacity="0.88"/>` +
    `<circle cx="231.4" cy="127.5" r="37.92" fill="url(#bm-g4)"/><circle cx="231.4" cy="127.5" r="11.38" fill="#fdf2d7" fill-opacity="0.82"/>`;
  const faviconSvg =
    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">` +
    `<defs>${NET_DEFS}</defs>` +
    `<rect width="256" height="256" rx="56" fill="#07090A"/>${NET_BODY}</svg>`;
...
<svg width="0" height="0" style="position:absolute" aria-hidden="true"><defs>
  ${NET_DEFS}
  <symbol id="bm-glyph" viewBox="0 0 256 256">${NET_BODY}</symbol>
</defs></svg>
