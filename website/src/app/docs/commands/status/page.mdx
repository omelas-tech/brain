...
export const metadata = docMeta("/docs/commands/status", {
...
💡 Recommendations
  • 5 memories are due for review — reinforced on next /brain:sleep
  • 6 weak memories could be consolidated — run /brain:sleep
...
|---|---|---|
| Memories due for review | Review queue has due items | Run `/brain:sleep` (reinforces due memories) |
| Weak memories accumulating | More than 5 memories below 0.3 | Run `/brain:sleep` (consolidates them) |
