...
export const metadata = docMeta("/docs/reference/file-structure", {
...
Used by the [/brain:sleep](/docs/commands/sleep/) replay pass to determine which memories are due for reinforcement.
