...
For the full changelog with detailed release notes, see the [GitHub Releases page](https://github.com/omelas-tech/brain/releases).

You can also view the raw commit history on [GitHub](https://github.com/omelas-tech/brain/commits/main).
