...
export const metadata = docMeta("/docs/concepts/strength-decay", {
...
Consolidation runs during the [sleep cycle](/docs/commands/sleep/) — see its consolidation phase for details.
