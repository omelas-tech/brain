...
Brain Memory works with **Claude Code**, **OpenAI Codex CLI**, **OpenCode**, and **Google Antigravity** — and with the **Claude.ai and ChatGPT apps** through a hosted [MCP](https://modelcontextprotocol.io) connector.
